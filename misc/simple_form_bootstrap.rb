...
def _replace_simple_form_setup(file_path, new_content)
  content = File.read(file_path)

  regex = /
    SimpleForm\.setup\s+do\s+\|config\|
    [\s\S]*?
    ^end\s*$
  /mx
  ...
  new_file = content.gsub(regex, new_content.rstrip)
  File.write(file_path, new_file)
end

def setup_simple_form_bootstrap
  _replace_simple_form_setup "config/initializers/simple_form_bootstrap.rb", <<~'CODE'
    SimpleForm.setup do |config|
      ...
      config.wrappers :horizontal_form, class: "row mb-3 pb-3 border-bottom horizontal-form-wrapper" do |b|
        b.use :html5
        b.use :placeholder
        b.optional :maxlength
        b.optional :minlength
        ...
        b.optional :min_max
        b.optional :readonly
        b.wrapper :label_wrapper, class: "col-sm-3" do |ba|
      ...
      config.wrappers :horizontal_boolean, class: "row mb-3 pb-3 border-bottom" do |b|
        b.use :html5
        b.optional :readonly
        ...
        b.wrapper :grid_wrapper, class: "col-sm-9 offset-sm-3" do |wr|
          wr.wrapper :form_check_wrapper, class: "form-check" do |bb|
            bb.use :input, class: "form-check-input", error_class: "is-invalid", valid_class: "is-valid"
            bb.use :hint, class: "form-check-label"
            bb.use :full_error, wrap_with: { class: "invalid-feedback" }
          end
        end
      end
      ...
      config.wrappers :horizontal_collection, item_wrapper_class: "form-check", item_label_class: "form-check-label",
        class: "row mb-3 pb-3 border-bottom" do |b|
        b.use :html5
        b.optional :readonly
        b.use :label, class: "col-sm-3 col-form-label pt-0"
        b.wrapper :grid_wrapper, class: "col-sm-9" do |ba|
      ...
      config.wrappers :horizontal_collection_inline, item_wrapper_class: "form-check form-check-inline",
        item_label_class: "form-check-label", class: "row mb-3 pb-3 border-bottom" do |b|
        b.use :html5
        b.optional :readonly
        b.use :label, class: "col-sm-3 col-form-label pt-0"
        b.wrapper :grid_wrapper, class: "col-sm-9" do |ba|
      ...
      config.wrappers :horizontal_file, class: "row mb-3 pb-3 border-bottom" do |b|
        b.use :html5
        b.use :placeholder
        b.optional :maxlength
        b.optional :minlength
      ...
      config.wrappers :horizontal_select, class: "row mb-3 pb-3 border-bottom" do |b|
        b.use :html5
        b.optional :readonly
        b.use :label, class: "col-sm-3 col-form-label"
        b.wrapper :grid_wrapper, class: "col-sm-9" do |ba|
      ...
      config.wrappers :horizontal_multi_select, class: "row mb-3 pb-3 border-bottom" do |b|
        b.use :html5
        b.optional :readonly
        b.use :label, class: "col-sm-3 col-form-label"
        b.wrapper :grid_wrapper, class: "col-sm-9" do |ba|
          ba.wrapper class: "d-flex flex-row justify-content-end align-items-center" do |bb|
      ...
      config.wrappers :horizontal_range, class: "row mb-3 pb-3 border-bottom" do |b|
        b.use :html5
        b.use :placeholder
        b.optional :readonly
        b.optional :step
      ...
      # inline input for multi select
      config.wrappers :inline_multi_select, class: "col-12" do |b|
        b.use :html5
        b.optional :readonly
        b.use :input, class: "form-select", error_class: "is-invalid", valid_class: "is-valid"
        b.use :label, class: "visually-hidden"
